...
\begin{highlight}
  \[
    \infer[\ref{rule:pill-cut}]
    {\judge{}{\res{xz}{(\recv{z}{}{\send{y}{}{\nil}} \pp \send{x}{}{\nil} \pp \recv{w}{}{\send{v}{}{\nil}})}}{\cht{y}{1} \pp \cht{w}{\bot}, \cht{v}{1}}}
    {\infer[\ref{rule:pill-mix}]
      {} % Original example derivation
      {} % Derivation for w().v().\nil
      }
  \]
\end{highlight}
...
\begin{remark}[On the Redundancy of Side Conditions]
...
\subsection{Operational Semantics for Typing Environments}
