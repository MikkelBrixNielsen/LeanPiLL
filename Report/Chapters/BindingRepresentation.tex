...
The corresponding Lean definitions for channels, opening and closing, and selected local-closure predicates are included in \cref{app:selected-definitions}; the full development is available in the accompanying codebase.