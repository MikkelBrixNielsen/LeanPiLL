...
This thesis focuses on a mechanised reconstruction of the \pill{} system of~\citet{abs-2106-11818}, with particular emphasis on its multiplicative fragment. The syntactic and typing components of \pill{} have been mechanised for the full system, including processes, session types, typing judgements, and substitution operations. The operational semantics are defined for the multiplicative fragment, for which the session-fidelity development addresses the project objective of relating process evolution to the linear-logic protocols represented by typing derivations. Within this fragment, completing the session-fidelity argument is reduced to the remaining \texttt{res} case of \path{typability_subject_reduction}$_\texttt{m}$.
